...
GLint RockNode::m_posLoc = -1;
GLint RockNode::m_colLoc = -1;
GLint RockNode::m_norLoc = -1;
...
: MeshNode("data/rock.obj", parent, false)
{
	...
	MeshNode::m_texCoordLoc = glGetAttribLocation(m_program, "texCoord");
...
void RockNode::draw(SceneParams* scene_params)
{
    ...
    glEnableVertexAttribArray(MeshNode::m_texCoordLoc);
    ...
    glVertexAttribPointer(MeshNode::m_texCoordLoc, 2, GL_FLOAT, 0, 0, 0);
    glDrawArrays(GL_TRIANGLES, 0, m_nVertices);

    glDisableVertexAttribArray(m_posLoc);
    glDisableVertexAttribArray(m_norLoc);
    glDisableVertexAttribArray(MeshNode::m_texCoordLoc);
}
